...
module Hadoop.Protos.YarnServerTimelineServerRecoveryProtos.TimelineDelegationTokenIdentifierDataProto
       (TimelineDelegationTokenIdentifierDataProto(..)) where
import Prelude ((+), (/))
...
data TimelineDelegationTokenIdentifierDataProto = TimelineDelegationTokenIdentifierDataProto{token_identifier ::
                                                                                             !(P'.Maybe
...
instance P'.Mergeable TimelineDelegationTokenIdentifierDataProto where
  mergeAppend (TimelineDelegationTokenIdentifierDataProto x'1 x'2) (TimelineDelegationTokenIdentifierDataProto y'1 y'2)
   = TimelineDelegationTokenIdentifierDataProto (P'.mergeAppend x'1 y'1) (P'.mergeAppend x'2 y'2)
 
instance P'.Default TimelineDelegationTokenIdentifierDataProto where
  defaultValue = TimelineDelegationTokenIdentifierDataProto P'.defaultValue P'.defaultValue
 
instance P'.Wire TimelineDelegationTokenIdentifierDataProto where
  wireSize ft' self'@(TimelineDelegationTokenIdentifierDataProto x'1 x'2)
   = case ft' of
       10 -> calc'Size
  ...
  wirePut ft' self'@(TimelineDelegationTokenIdentifierDataProto x'1 x'2)
   = case ft' of
       10 -> put'Fields
       11 -> do
