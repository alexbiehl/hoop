...
module Hadoop.Protos.RefreshUserMappingsProtocolProtos.RefreshSuperUserGroupsConfigurationRequestProto
...
instance P'.ReflectDescriptor RefreshSuperUserGroupsConfigurationRequestProto where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".hadoop.common.RefreshSuperUserGroupsConfigurationRequestProto\", haskellPrefix = [MName \"Hadoop\",MName \"Protos\"], parentModule = [MName \"RefreshUserMappingsProtocolProtos\"], baseName = MName \"RefreshSuperUserGroupsConfigurationRequestProto\"}, descFilePath = [\"Hadoop\",\"Protos\",\"RefreshUserMappingsProtocolProtos\",\"RefreshSuperUserGroupsConfigurationRequestProto.hs\"], isGroup = False, fields = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False}"
