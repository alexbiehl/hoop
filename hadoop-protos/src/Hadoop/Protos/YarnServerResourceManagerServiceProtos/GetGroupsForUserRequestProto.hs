...
module Hadoop.Protos.YarnServerResourceManagerServiceProtos.GetGroupsForUserRequestProto (GetGroupsForUserRequestProto(..)) where
import Prelude ((+), (/))
