...
module Hadoop.Protos.AclProtos.RemoveAclEntriesRequestProto (RemoveAclEntriesRequestProto(..)) where
import Prelude ((+), (/))
...
data RemoveAclEntriesRequestProto = RemoveAclEntriesRequestProto{src :: !(P'.Utf8), aclSpec :: !(P'.Seq AclProtos.AclEntryProto)}
                                  deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data)
 
instance P'.Mergeable RemoveAclEntriesRequestProto where
  mergeAppend (RemoveAclEntriesRequestProto x'1 x'2) (RemoveAclEntriesRequestProto y'1 y'2)
   = RemoveAclEntriesRequestProto (P'.mergeAppend x'1 y'1) (P'.mergeAppend x'2 y'2)
 
instance P'.Default RemoveAclEntriesRequestProto where
  defaultValue = RemoveAclEntriesRequestProto P'.defaultValue P'.defaultValue
 
instance P'.Wire RemoveAclEntriesRequestProto where
  wireSize ft' self'@(RemoveAclEntriesRequestProto x'1 x'2)
   = case ft' of
       10 -> calc'Size
  ...
  wirePut ft' self'@(RemoveAclEntriesRequestProto x'1 x'2)
   = case ft' of
       10 -> put'Fields
       11 -> do
